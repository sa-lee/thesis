...
A complimentary approach for visualizing structure in high dimensional data is
...
### Making comparisons: think global, act local

Aside from simple
linked brushing, we can also pose more complex queries via interrogating
the neighbourhood graph. Using a linked neighbourhood brush, we can 
