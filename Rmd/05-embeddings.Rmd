...
```{r gaussian, eval = knitr::is_latex_output()}
```
...
```{r trees-01, eval = knitr::is_latex_output()}
```
...
```{r trees-02, eval = knitr::is_latex_output()}
```
...
```{r mouse-01, eval = knitr::is_latex_output()}
```
...
```{r mouse-02, eval = knitr::is_latex_output()}
```
