...
@Wickham2015-cx and exploring statistical model fits and by @Buja1996-fk for 
...
implementing this brush in **liminal**,  using the  **FNN** or **RcppAnnoy**
packages for fast neighbourhood estimation on the server side, however there
are still technicalaties that need be resolved [@fnn-pkg; @rcpp-annoy-pkg]. 
...
```{r vimeo}
knitr::kable(dplyr::select(vid_lookup, `Case Study` = key, `URL` = url), 
