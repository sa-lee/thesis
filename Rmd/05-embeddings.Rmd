...
We present a visual <change word here> framework for the pragmatic usage of NLDR methods
...
optimisation parameters in real-time. <!-- add visualising with mds reference -->
...
#### Spherical Gaussian clusters with hierarchical structure
