...
running some non-linear embedding methods live in the browser and 
...
methods, there are many parameters to explore that can have an effect on
...
covariance matrix [@Hotelling1933-ck]. The eigenvalues are sorted in decreasing order and represent
...
As the perplexity increases, $\sigma^2_{i}$ increases, until it is bounded above
...
So when the loss function is minimised this corresponds to large attractive
...
(ref:liminal-gaussian) Screenshots of the **liminal** interface applied to well clustered data, a video of the tour animation is available at https://player.vimeo.com/video/439635921.
...
(ref:liminal-hierarchical) Screenshots of the **liminal** interface applied to sub-clustered data, a video of the tour animation is available at https://player.vimeo.com/video/439635905.
...
```{r mouse-01, fig.cap = "(ref:mouse-01)", out.height = "85%"}
...
(ref:mouse-02) Screenshots of the **liminal** tour applied to a marker gene set, a video of the tour animation is available at https://player.vimeo.com/video/439635843. 
