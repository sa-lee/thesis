...
mention several other techniques [@Maaten2008-sk; @McInnes2018-co]. 
...
using a t-distribution with 1 degree of freedom [@Maaten2008-sk]. There are several subtleties
...
the shape and global structure of a dataset via inspection of the subspace generated by the set of low-dimensional projections. In fact, in some
of the case studies below, we first sphere our data via principal 
components to reduce dimensionality of our input. 

Like, when using other DR techniques, the tour assumes we have a real data matrix
...
visualise guided tours, our focus in the case studies uses the grand tour to see global structure in the data. 
...
and stand alone interfaces for manipulating tour paths via the **shiny** and **tourr** packages [@Chang2020-bq; @Wickham2011-st].
...
or 'not' brushes, could be used to interrogate mismatches between the 
...
We would like to thank Dr David Frazier, Dr Ursula Laa and Dr Paul Harrison for their feedback on this work. 
