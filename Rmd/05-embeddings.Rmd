...
This can be used for either manually identifying clusters, or verifying the location of clusters relative to other groupings. Consequently, simple linked
brushing can alleviate a downfall of non-linear methods such as UMAP or t-SNE
that break hierarchical structure of clusters. Aside from simple
