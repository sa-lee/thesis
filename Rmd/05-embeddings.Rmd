...
vid_lookup <- tibble::tribble(
  ~key, ~url, ~path,
  "gaussian",  "https://player.vimeo.com/video/439635921", here::here("img", "liminal-screenshot-gaussian.png"),
  "hierarchical", "https://player.vimeo.com/video/439635905", here::here("img", "liminal-screenshot-hierarchical.png"),
  "trees-01", "https://player.vimeo.com/video/439635892", here::here("img", "liminal-screenshot-trees-01.png"),
  "trees-02", "https://player.vimeo.com/video/439635863", here::here("img", "liminal-screenshot-trees-02.png"),
  "mouse-01", "https://player.vimeo.com/video/439635812", here::here("img", "liminal-screenshot-mouse-01.png"),
  "mouse-02", "https://player.vimeo.com/video/439635843", here::here("img", "liminal-screenshot-mouse-02.png")
)
...
software called **XGobi** and **GGobi** into a new tool called **GGvis** 
...
view as has been done in previous tour interfaces **XGobi** and **DataViewer** 
...
(ref:liminal-gaussian) Screenshots of the **liminal** interface applied to well clustered data, a video of the tour animation is available at https://player.vimeo.com/video/439635921. *(a)*: t-SNE (left) and tour (right) in side by side layout coloured by cluster. *(b)*: brushing the red cluster on the t-SNE view, shows the corresponding points on the tour.
...
(ref:trees-01) Screenshots of the **liminal** interface applied to tree structured data, a video of the tour animation is available at https://player.vimeo.com/video/439635892. *(a)*: Default t-SNE has difficulties embedding the tree. *(b)* linked highlighting shows that the backbone of the tree has been broken by the embedding.    
...
indicating that these genes are expressed in all four clusters (figure \@ref(fig:mouse-02)a). Using zooming, we can see a trajectory forming along
...
We would like to thank Dr David Frazier, Dr Ursula Laa and Dr Paul Harrison for 
their feedback on this work. The screenshots and images were compiled using the 
**cowplot** and **ggplot2** packages [@r-cowplot; @Wickham2016-gz].
