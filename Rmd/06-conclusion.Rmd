...
To finish, I will dicuss the implications of this work and provide 
...
that do not fit in memory. We attempted several techniques for perfoming 
...
like HDF5 that leverages existing Bioconductor frameworks would be useful.
We showed in chapters \@ref(ch:fluentGenomics) ad \@ref(ch:intron) that an a
nalyst is able to do some very complex data transformations and resampling 
...
We showed in chapter \@ref(ch:liminal) that tours provide a global overview
