...
This thesis focuses on three core aspects of EDA as part of a biological data
science workflow: wrangling, integration and visualisation (in particular we 
focus on the exploration of genomics and transcriptomics data).
It is organised in the same manner that you would iterate back and
...
introudces a grammar-based framework for transforming genomics data that is 
...
visualisations of your data; section {#sec:va} introduces a visual analytics 
approach for understanding non-linear dimension reduction techniques and is described in
detail in chapter \@ref(ch:tsne). Lastly, you take a step back and look at
the implications and limitations of your work; in chapter \@ref(ch:conclusion)
I describe the outpus of my thesis and plans for future research. 
