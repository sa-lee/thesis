...
forth between these tasks  during an analysis. To begin you wrangle your data into a structure 
that you can understand and use; section \@ref(sec:tidygranges) introudces a
grammar-based framework for transforming genomics data that is described in 
chapter \@ref(ch:plyranges). Next, you integrate data and model outputs
over genomic regions to gain biological insight; \@ref(sec:ir) introduces a
framework for incorporating and discovering 'interesting' genomic regions,
described further in chapters \@ref(ch:fluentGenomics) and \@ref(ch:intron).
Third, you cycle between model-based representations and visualisations
of your data; section {#sec:va} introduces a visual analytics approach for
understanding non-linear dimension reduction techniques and is described in
...
I describe the impacts of my work and plans for future research. 
...
can be used to glue two different approaches
