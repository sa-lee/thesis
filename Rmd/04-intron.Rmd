# Tidy coverage analysis and visualisation with superintronic {#ch:intron}
...
### Discovery of regions of interest via 'ranglers'



### A superintronic workflow for uncovering intron retention
...
The coverage of remaining 7 genes appear to be more pre-mRNA-like, with large variation in intron coverage, where at its peak it is expressed similarly to exon features. 
