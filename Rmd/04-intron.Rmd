...
introns (called U12 introns in this case but there exist other classes in eukaryotic organisms) are removed from pre-mRNA prior to gene expression. The removal of these introns is catalysed by small ribonucleoproteins (snRNPs)
...
with evidence for intron retention using a knockout experiment in zebrafish.
