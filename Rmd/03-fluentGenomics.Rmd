# Fluent genomics: integrating data with plyranges and tximeta {#ch:fluentGenomics}
...
*integrate* them. First, we compute the overlap between the results of each
...
(ref:maplot) Visualization of *DESeq2* results as an "MA plot". Genes that have
an adjusted *p-value* below 0.01 are colored red.
