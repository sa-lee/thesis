...
```{r load-bw, echo = TRUE, cache = TRUE}
```
...
```{r chr10-scores-read, echo = TRUE, cache = TRUE}
```
...
```{r chr10-scores-reduce, echo = TRUE, cache = TRUE}
```
...
```{r process-array, echo = TRUE, cache = TRUE}
```
